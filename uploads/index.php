...
session_start(); // start session or continue session if there is one

// add outside resources for controller
...
// get action value for the controllers switch statement
